  ...
  const handleSubmit = async (event) => {
    ...
    if (roleFormData.id) {
      ...
      const response = axios.put(
        UPDATE_ROLE_URL + roleFormData.id,
        roleFormData,
        {
          headers: {
            Authorization: JSON.parse(lt),
      ...
      try {
        ...
        setroleError("Role already present");
      }
    }
  };
            ...
            <TableBody>
              {roles.map((role) => (
                ...
                >
                  ...
                  <TableCell align="left">{role.createdBy}</TableCell>
                  ...
                  <TableCell align="left">{role.lastUpdatedBy}</TableCell>
